...
-- Generation Time: Nov 26, 2019 at 11:41 PM
...
(10, 4, '', 'Тестовый пост 3', 'Краткое описание статьи \"Тестовый пост\"', '42342', '', ''),
(79, 2, 'en', 'ENG Адаптивный дизайн сайта и основные стратегии по его внедрению', 'ENG Адаптивный дизайн сайта — это совершенно новый подход к диза', '<p>ENG Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia optio odit unde quam dolore vel vitae in! Obcaecati velit rem alias exercitationem error eveniet autem, voluptatibus esse ab placeat blanditiis omnis! Necessitatibus, officia velit, laboriosam deleniti quis aperiam? Nesciunt inventore consequuntur dolores, excepturi magnam illum modi unde quis sit deserunt.</p>', 'адаптивный дизайн', 'Адаптивный дизайн сайта и основные стратегии по его внедрению');
...
(6, 'webuxmotion', '$2y$10$23D.4K/JKBJ1IBfUSRyy4uEkOU2b7Nx.LyWvgOSBGFX9.8uRrBqfW', 'pereverziev.andrii@gmail.com', 'Andrii Pereverziev', 'user'),
(7, 'we', '$2y$10$BVm3auA/JJfe6xr3z8SHCerd7iLOIWoFWOF0Hqgm6R6JTVuy/ITxe', 'zvo.agency@gmail.com', 'Andrii Pereverziev', 'user'),
(8, 'n', '$2y$10$bHDKgS5KaMR1mIjoiSUP1uJe11XirhQOsYIz4wgA7zaSHbYghz28y', 'y4t6official@gmail.com', 'Andrii Pereverziev', 'user'),
(9, 'user2', '$2y$10$bPyOGW.t.vqtZ2mhnLWAwexRlfwIwZnMpZzJFuOL89N3KJkNziqci', 'user2@gmail.com', 'Andrii User 2', 'user');
